...
layout1 = [
    [Btn(key='plus',image_filename='plus25.png'),Btn('dot',image_filename='detail25.png'),Btn('batsu',image_filename='delete25.png')],
    ...
    [Btn(key='a',image_filename='plus25.png'),Btn(key='b',image_filename='plus25.png')]
    ]
